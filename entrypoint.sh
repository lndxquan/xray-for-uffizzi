...
UUID='35c1786a-9de4-4622-9f46-1d00f72e621f'
VMESS_WSPATH='/mess_beifengjihuazhengwen'
VLESS_WSPATH='/ess_beifengjihuazhengwen'
TROJAN_WSPATH='/jan_beifengjihuazhengwen'
SS_WSPATH='/ocks_beifengjihuazhengwen'
NEZHA_SERVER=''
NEZHA_PORT=''
NEZHA_KEY=''
